...
type MultiTargetDamagePlanItem = { targetId: string; amount: number };
...
export class GameEngine {
    ...
    constructor(
        ...
        this.cpuActionDelayMs = options.cpuActionDelayMs ?? 2000;
    }
    ...
    roleAttack(playerId: string, targetId: string, options?: { struggle?: boolean }): void {
        ...
        let atk = getEffectiveStatValue(attackerRuntimeAfterEquip, 'atk') + Math.max(0, Math.floor(nextRoleAttackAtkBonus));
