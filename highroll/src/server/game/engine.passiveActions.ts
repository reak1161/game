...
type ExecuteAbilityActionsCoreParams = {
    ownerId: string;
    ability: RoleAbility;
...
// パッシブ/アビリティの action 群を共通処理として実行する。
export const executeAbilityActionsCore = (params: ExecuteAbilityActionsCoreParams): AbilityTriggerResult => {
    const {
        ownerId,
        ability,
        context,
