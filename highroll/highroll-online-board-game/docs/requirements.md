...
6. ログ表示を画面右カラムにまとめ、ターン進行を常に確認できるようにする。
7. ロールごとの詳細説明を UI 上から参照できるようにする (ロール図鑑 / ポップオーバー)。
8. デッキビルダーやカード一覧にタグ検索・絞り込み機能を追加し、カード探索を容易にする。
9. 追加トークン (Atk/Def/Spe/Bra) はプラスとマイナスを相殺して最終値を表示するようエンジンを拡張。
