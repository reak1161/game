...
def disp_gauge(player):
    # プレイヤーHP表示（仮）
    for i in range(4):
        pygame.draw.rect(lm.screen, colors.SILVER, [1208*lm.resol[0]/1920, (232+i*(40+128+48))*lm.resol[1]/1080, 256*lm.resol[0]/1920, 24*lm.resol[1]/1080])
        
        # HPが半分以上なら緑
        if player[i].disp_HP / player[i].HP >= 0.50:
            pygame.draw.rect(lm.screen, colors.GREEN, [1208*lm.resol[0]/1920, (232+i*(40+128+48))*lm.resol[1]/1080, 256*(player[i].disp_HP/player[i].HP)*lm.resol[0]/1920, 24*lm.resol[1]/1080])
        # HPが２割以上半分未満なら黄色
        elif player[i].disp_HP / player[i].HP >= 0.20:
            pygame.draw.rect(lm.screen, colors.YELLOW, [1208*lm.resol[0]/1920, (232+i*(40+128+48))*lm.resol[1]/1080, 256*(player[i].disp_HP/player[i].HP)*lm.resol[0]/1920, 24*lm.resol[1]/1080])
        # HPが２割未満なら赤
        else:
            pygame.draw.rect(lm.screen, colors.RED, [1208*lm.resol[0]/1920, (232+i*(40+128+48))*lm.resol[1]/1080, 256*(player[i].disp_HP/player[i].HP)*lm.resol[0]/1920, 24*lm.resol[1]/1080])
    ...
    for i in range(4):
        ...
        pygame.draw.rect(lm.screen, colors.BLUEVIOLET, [1208*lm.resol[0]/1920, (288+i*(40+128+48))*lm.resol[1]/1080, 256*(player[i].Mgc.left_MP/player[i].Mgc.MP)*lm.resol[0]/1920, 24*lm.resol[1]/1080])
    ...
    for i in range(4):
        ...
        pygame.draw.rect(lm.screen, colors.YELLOW, [1208*lm.resol[0]/1920, (344+i*(40+128+48))*lm.resol[1]/1080, 256*(player[i].action/1000)*lm.resol[0]/1920, 24*lm.resol[1]/1080])
